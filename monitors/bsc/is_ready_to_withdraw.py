...
class IsReadyToWithdraw(Monitor):
    event_type = "is_ready_to_withdraw"
    ...
    def on_new_block_event(self, block_event: BlockEvent):
        ...
        event_filter = contract.events.IsReadyToWithdraw().createFilter(fromBlock=block.number, toBlock=block.number)
